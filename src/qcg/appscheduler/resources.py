...
class NodeCores:
    ...
    def __init__(self, name=None, totalCores=0, used=0, coreIds=None, freeCores=None):
        """
        Node resources.
    ...
    def toDict(self):
        ...
        return { 'name': self.__name, 'totalCores': self.__totalCores, 'coreIds': list(self.__coreIds),
                 'freeCores': list(self.__freeCores) }
    ...
    def fromDict(data):
        ...
        """
        return NodeCores(data['name'], data['totalCores'], data['totalCores'] - len(data['freeCores']),
