...
def test_scheduler_allocate_cores():
    ...
    assert a1 and all((a1.cores == c1, len(a1.nodes) == 1, a1.nodes[0].cores == list(range(c1)), a1.nodes[0].crs == None))
    ...
    assert a2 and all((a2.cores == c2_max, len(a2.nodes) == 2,
        a2.nodes[0].cores == list(range(c1, nCores[0])), a2.nodes[0].crs == None,
        a2.nodes[1].cores == list(range(c1 + c2_max - nCores[0])), a2.nodes[0].crs == None))
    ...
    assert a3 and all((a3.cores == c3_max, len(a3.nodes) == 1,
        a3.nodes[0].cores == list(range(c3_max)), a3.nodes[0].crs == None))
    ...
    assert a4 and all((a4.cores == c4, len(a4.nodes) == 3,
        a4.nodes[0].cores == list(range(c1 + c2_max - nCores[0], nCores[1])), a4.nodes[0].crs == None,
        a4.nodes[1].cores == list(range(nCores[2])), a4.nodes[1].crs == None,
        a4.nodes[2].cores == list(range(nCores[3])), a4.nodes[2].crs == None))
...
def test_scheduler_allocate_job_gpus():
    ...
    assert a1 and all((a1.cores == job1_r_c * job1_r_n, len(a1.nodes) == job1_r_n,
        a1.nodes[0].node.name == "n.0", a1.nodes[0].cores == list(range(job1_r_c))))
    ...
    assert a2 and all((a2.cores == job2_r_c * job2_r_n, len(a2.nodes) == job2_r_n,
        a2.nodes[0].node.name == "n.1", a2.nodes[0].cores == list(range(job2_r_c))))
    ...
    assert a5 and all((a5.cores == job5_r_c * job5_r_n, len(a5.nodes) == job5_r_n,
        a5.nodes[0].node.name == "n.1", a5.nodes[0].cores == list(range(job2_r_c, job2_r_c + job5_r_c)),
        a5.nodes[1].node.name == "n.2", a5.nodes[1].cores == list(range(job5_r_c)),
        a5.nodes[2].node.name == "n.3", a5.nodes[2].cores == list(range(job5_r_c)))), str(a5)
    ...
    assert a6 and all((a6.cores == job6_r_c, len(a6.nodes) == 4,
        a6.nodes[0].node.name == "n.0", a6.nodes[0].cores == list(range(job1_r_c, nCores[0])),
        a6.nodes[1].node.name == "n.1", a6.nodes[1].cores == list(range(job2_r_c + job5_r_c, nCores[1])),
        a6.nodes[2].node.name == "n.2", a6.nodes[2].cores == list(range(job5_r_c, nCores[2])),
        a6.nodes[3].node.name == "n.3", a6.nodes[3].cores == list(range(job5_r_c, job5_r_c + 4)))), str(a6)
