...
## Documentation
The documentation to the QCG PilotJob Manager is available at readthedocs.org

## Installation
The latest stable version of QCG PilotJoa Manager can be installed with pip
